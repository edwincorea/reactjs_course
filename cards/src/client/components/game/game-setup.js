...
export default class GameSetup extends ContainerBase {
    constructor(props) {
        ...
        this._setScoreLimit = this._setScoreLimit.bind(this);
        this._toggleSet = this._toggleSet.bind(this);
    ...
    render() {
        ...
        return <section className={`c-game-settings ${disabled ? "disabled" : "enabled"}`}>
                   <h1>
                       Game Options
                       {!error ? null : 
